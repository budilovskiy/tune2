...
public class AppGUI extends JFrame implements PlayListener {
	...
	private void initComponents() {
		...
		searchField.setBounds(374, 30, 178, 22); // set absolute position and
													// size
	...
	private void displayTrackInfo(Track currentTrack) {
		...
		if (currentTrack.getName().length() > 45) {
			...
			UIManager.put("ToolTip.font", new FontUIResource("Calibri",
					Font.PLAIN, 11));
		} else {
		...
		try {
			BufferedImage image = ImageIO.read(new URL(currentTrack
					.getImageURL()));
	...
	public static String getDefaultSearchText() {
	...
	public static void main(String... args) {
		...
		UIManager.put("nimbusOrange", new Color(0, 174, 239));
	...
	private final static String DEFAULT_SEARCH_TEXT = "enter tag or artist to search";
